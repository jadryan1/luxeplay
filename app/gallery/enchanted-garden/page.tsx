...
export default function EnchantedGardenPage() {
    return (
        <ThemePageContent
            ...
            gender="Girls"
            heroColor="#E4D5E8"
            description="A garden that exists only in her imagination, brought to life just for her. Trailing lavender balloons, butterfly-dusted table settings, and a fairy arch that shimmers with gold. Pure magic for her, pure taste for you."
